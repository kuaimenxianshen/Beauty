package com.cclinux.projects.meetbeauty.service.admin;
...
import com.cclinux.projects.meetbeauty.comm.ProjectConfig;
...
import com.cclinux.projects.meetbeauty.service.cust.MeetService;
...
@Service("MeetBeautyAdminMeetService")
public class AdminMeetService extends BaseMyAdminService {
    ...
    @Resource(name = "MeetBeautyMeetService")
    ...
    public long insertMeet(MeetModel meet) {
        appError("{美容}该功能暂不开放，如有需要请加作者微信：cclinux0730");
