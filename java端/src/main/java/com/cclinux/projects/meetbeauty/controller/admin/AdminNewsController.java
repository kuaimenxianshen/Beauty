...
import com.cclinux.projects.meetbeauty.service.admin.AdminNewsService;
...
@RestController("MeetBeautyAdminNewsController")
public class AdminNewsController extends BaseMyAdminController {

    @Resource(name = "MeetBeautyAdminNewsService")
