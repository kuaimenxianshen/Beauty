...
import com.cclinux.projects.meetbeauty.service.admin.AdminUserService;
...
@RestController("MeetBeautyAdminUserController")
public class AdminUserController extends BaseMyAdminController {

    @Resource(name = "MeetBeautyAdminUserService")
