...
import com.cclinux.projects.meetbeauty.service.admin.AdminMeetService;
...
@RestController("MeetBeautyAdminMeetController")
public class AdminMeetController extends BaseMyAdminController {

    @Resource(name = "MeetBeautyAdminMeetService")
