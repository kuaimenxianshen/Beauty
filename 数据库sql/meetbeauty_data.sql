...
-- ----------------------------
-- Table structure for meetbeauty_admin
-- ----------------------------
DROP TABLE IF EXISTS `meetbeauty_admin`;
CREATE TABLE `meetbeauty_admin`  (
...
INSERT INTO `meetbeauty_admin` VALUES (1, 'admin', 'e10adc3949ba59abbe56e057f20f883e', 'admin', NULL, 1, 1, 1, 0, 0, 0);

-- ----------------------------
-- Table structure for meetbeauty_fav
-- ----------------------------
DROP TABLE IF EXISTS `meetbeauty_fav`;
CREATE TABLE `meetbeauty_fav`  (
...
-- ----------------------------
-- Table structure for meetbeauty_meet
-- ----------------------------
DROP TABLE IF EXISTS `meetbeauty_meet`;
CREATE TABLE `meetbeauty_meet`  (
...
-- ----------------------------
-- Table structure for meetbeauty_meet_join
-- ----------------------------
DROP TABLE IF EXISTS `meetbeauty_meet_join`;
CREATE TABLE `meetbeauty_meet_join`  (
...
-- ----------------------------
-- Table structure for meetbeauty_news
-- ----------------------------
DROP TABLE IF EXISTS `meetbeauty_news`;
CREATE TABLE `meetbeauty_news`  (
...
-- ----------------------------
-- Table structure for meetbeauty_setup
-- ----------------------------
DROP TABLE IF EXISTS `meetbeauty_setup`;
CREATE TABLE `meetbeauty_setup`  (
...
-- ----------------------------
-- Table structure for meetbeauty_user
-- ----------------------------
DROP TABLE IF EXISTS `meetbeauty_user`;
CREATE TABLE `meetbeauty_user`  (
